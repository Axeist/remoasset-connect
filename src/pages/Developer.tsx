          ...
          <div className="space-y-4">
            ...
            <Card className="card-shadow border-border/60 p-4">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                ...
                <Button variant="outline" size="sm" className="shrink-0 gap-1.5 text-xs" onClick={fillSessionToken}>
              ...
              {!apiKey && (
                <p className="mt-2 text-xs text-muted-foreground flex items-center gap-1.5">
                  ...
                  Create API keys in the API Keys tab. Or click "Use session token" to test with your current login.
                </p>
              )}
            </Card>
