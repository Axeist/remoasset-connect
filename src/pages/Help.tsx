        ...
        <Accordion type="single" collapsible className="w-full space-y-2" defaultValue={['getting-started']}>
            ...
            <AccordionContent className="pb-5 text-sm text-muted-foreground space-y-4">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="mb-2">
                    Central place for all leads. Add leads manually (required: company name, website, country, status, vendor types (one or more); optional: email, phone, contact name, designation, notes). Use filters (search, status, country, vendor type, warehouse, owner, score range) and choose how many rows per page. Open a lead to view or edit details, log activities (call, email, meeting, note), add tasks and follow-ups, upload documents, and see the full activity log with lead score points (+6 for calls, +3 for email, etc.). Admins can delete individual leads or use bulk actions (e.g. change owner); bulk changes are recorded in the activity feed.
                  </p>
                  <p className="text-xs text-muted-foreground/90">
          ...
          <AccordionItem value="leads" id="leads" className="border rounded-xl px-4 bg-card/50">
            ...
            <AccordionContent className="pb-5 text-sm text-muted-foreground space-y-4">
              ...
              <p>
                Use <strong className="text-foreground">Add lead</strong> to create a new lead. Required fields: Company name, Website, Country, Status, and Vendor types (one or more). Optional: Email, Phone, Contact name, Designation, Notes. If <strong className="text-foreground">Warehouse available</strong> is turned on, you can add Warehouse location, notes, price, and currency. All edits are logged in the lead’s Activity tab with the fields that changed.
              </p>
